...
#s? executar se precisar ler e transformar novamente o banco para csv.


# setwd("C:/Users/dr2p/Desktop/Banco do Geds/bancos")
# 
# input <- dir()
...
# rm(L)
# 
# dir.create("C:/Users/dr2p/Desktop/Banco do Geds/bancos_csv")
# setwd("C:/Users/dr2p/Desktop/Banco do Geds/bancos_csv")
# 
...
# rm(L)
# 
# setwd("C:/Users/dr2p/Desktop/Banco do Geds")


#s? rodar se precisar instalar esses pacotes caso n?o tenha.
...
AIHS%>%
  tally  ## 16 milh?es de interna??es! pqp
